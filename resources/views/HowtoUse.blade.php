            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    ...
                    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-indigo-500 text-white relative z-10 title-font font-medium text-sm">5    
                        </div>
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            <div class="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
                ...
                <div class="lg:w-4/6 mx-auto">
                    <div class="flex flex-col sm:flex-col mt-10 justify-center text-center mb-6">
                        <h1 class="sm:text-3xl text-3xl font-medium title-font mb-6 mt-6 text-gray-900">※時々、登録したメールアドレス宛に運営からアンケートなどを送らせていただきます。
                            <br>
                            サービス・品質の向上のため、ご回答のご協力お願いいたします！</h1>
                    </div>
                </div>
